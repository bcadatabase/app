            ...
            <div className="rounded-t mb-0 px-6 py-6">
              ...
              <div className="flex-auto px-4 lg:px-10 py-10 pt-0">
                <div className="text-blueGray-400 text-center mb-3 font-bold">
                  <small>Please fill up all details correctly.</small>
                </div>
                <form onSubmit={(e) => submit(e)}>
                  ...
                  <div className="relative w-full mb-3">
                    <label
                      ...
                      htmlFor="grid-password"
                    >
                      Gmail Adress (You will recive an OTP on this email)
                    </label>
                    <input
                      type="email"
                      className="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150"
                  ...
                  <div className="relative w-full mb-3">
                    <label
                      ...
                      htmlFor="grid-password"
                    >
                      Phone Number (without 0 or country code)
                    </label>
                    <input
            ...
            <div className="flex flex-wrap mt-6 relative">
              <div className="w-1/2 cursor-pointer">
                <a
                  ...
                  onClick={(e) => {
                    e.preventDefault();
                    props.page("Auth","LoginPage");
                  }}
                  className="text-blueGray-200"
                >
                  <small>having an account? Go for login</small>
                </a>
              </div>
              ...
              <a
                  ...
                  className="text-blueGray-200"
                >
                  <small>Want to login with OTP?</small>
                </a>
              </div>
            </div>
          </div>
